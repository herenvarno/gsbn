...
void Pop::init_new(SolverParam solver_param, PopParam pop_param, Database& db, vector<Pop*>* list_pop, int *hcu_cnt, int *mcu_cnt, Msg *msg, int norm_frac_bit, int p_frac_bit){
	CHECK(list_pop);
	_list_pop=list_pop;
	CHECK(msg);
	_msg=msg;
