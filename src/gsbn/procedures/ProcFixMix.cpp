#include "gsbn/procedures/ProcFixMix.hpp"

namespace gsbn{
namespace proc_fix_mix{

REGISTERIMPL(ProcFixMix);

void ProcFixMix::init_new(SolverParam solver_param, Database& db){
...
void ProcFixMix::init_copy(SolverParam solver_param, Database& db){
