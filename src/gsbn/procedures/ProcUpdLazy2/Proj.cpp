...
void Proj::init_new(int max_cycle, ProcParam proc_param, ProjParam proj_param, Database& db, vector<Proj*>* list_proj, vector<Pop*>* list_pop, Msg *msg){
	...
	_siq->mutable_cpu_vector()->resize(max_cycle * _dim_hcu * _dim_conn);
...
void Proj::init_copy(int max_cycle, ProcParam proc_param, ProjParam proj_param, Database& db, vector<Proj*>* list_proj, vector<Pop*>* list_pop, Msg *msg){
