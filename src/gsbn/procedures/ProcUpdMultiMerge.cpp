#include "gsbn/procedures/ProcUpdMultiMerge.hpp"

namespace gsbn{
namespace proc_upd_multi_merge{

REGISTERIMPL(ProcUpdMultiMerge);

void ProcUpdMultiMerge::init_new(SolverParam solver_param, Database& db){
...
void ProcUpdMultiMerge::init_copy(SolverParam solver_param, Database& db){
	NetParam net_param = solver_param.net_param();
...
void ProcUpdMultiMerge::update_cpu(){
	int cycle_flag;
...
void ProcUpdMultiMerge::update_gpu(){
