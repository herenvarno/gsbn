#ifndef __GSBN_PROC_UPD_LAZY_HPP__
#define __GSBN_PROC_UPD_LAZY_HPP__
 ...
 * debug purpose.
 */
class ProcUpdLazy : public ProcedureBase{

REGISTER(ProcUpdLazy)
...
#endif // __GSBN_PROC_UPD_LAZY_HPP__
