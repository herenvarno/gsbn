#ifndef __GSBN_PROC_UPD_LAZY_ADA_HPP__
#define __GSBN_PROC_UPD_LAZY_ADA_HPP__
 ...
 * debug purpose.
 */
class ProcUpdLazyAda : public ProcedureBase{

REGISTER(ProcUpdLazyAda)
...
#endif // __GSBN_PROC_UPD_LAZY_ADA_HPP__
