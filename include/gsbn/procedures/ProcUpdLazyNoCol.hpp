#ifndef __GSBN_PROC_UPD_LAZY_NO_COL_HPP__
#define __GSBN_PROC_UPD_LAZY_NO_COL_HPP__
 ...
 * debug purpose.
 */
class ProcUpdLazyNoCol : public ProcedureBase{

REGISTER(ProcUpdLazyNoCol)
