#ifndef __GSBN_PROC_FIX_MIX32_PROJ_HPP__
#define __GSBN_PROC_FIX_MIX32_PROJ_HPP__
...
public:
	...
	void init_new(SolverParam solver_param, ProjParam proj_param, Database& db, vector<Proj*>* list_proj, vector<Pop*>* list_pop, Msg *msg, int norm_frac_bit, int p_frac_bit);
