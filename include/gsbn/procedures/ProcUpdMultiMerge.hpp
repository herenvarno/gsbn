#ifndef __GSBN_PROC_UPD_MULTI_MERGE_HPP__
#define __GSBN_PROC_UPD_MULTI_MERGE_HPP__

#include "gsbn/Database.hpp"
#include "gsbn/ProcedureFactory.hpp"
#include "gsbn/procedures/ProcUpdMultiMerge/Pop.hpp"
#include "gsbn/procedures/ProcUpdMultiMerge/Proj.hpp"

namespace gsbn{
namespace proc_upd_multi_merge{

/**
 * \class ProcUpdMultiMerge
 ...
 * debug purpose.
 */
class ProcUpdMultiMerge : public ProcedureBase{

REGISTER(ProcUpdMultiMerge)
...
#endif // __GSBN_PROC_UPD_MULTI_MERGE_HPP__
