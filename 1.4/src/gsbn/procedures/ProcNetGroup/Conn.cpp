...
void Conn::init_copy(ProjParam proj_param, Database& db, vector<Conn*>* list_conn, int w){
	...
	_pi->mutable_gpu_vector()->reserve(10000);
	_ei->mutable_gpu_vector()->reserve(10000);
	_zi->mutable_gpu_vector()->reserve(10000);
	_ti->mutable_gpu_vector()->reserve(10000);
	_pij->mutable_gpu_vector()->reserve(10000);
	_eij->mutable_gpu_vector()->reserve(10000);
	_zi2->mutable_gpu_vector()->reserve(10000);
	_zj2->mutable_gpu_vector()->reserve(10000);
	_tij->mutable_gpu_vector()->reserve(10000);
